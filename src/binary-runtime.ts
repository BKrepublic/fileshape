...
/**
 * Environment-neutral synchronous SHA-256 used by model validation, where the
 * complete image bytes are already in memory and validation itself is sync.
 * Runtime providers remain responsible for source/document hashing.
 */
