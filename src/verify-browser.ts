...
async function main(): Promise<void> {
  ...
  requireMatch(browserSources, /pako\/browser\/deflate/, "browser binary runtime must use the pinned deterministic deflate provider");
  requireMatch(browserSources, /legacyHash:\s*true/, "browser deflate provider must explicitly select the stock-zlib-compatible hash path");
